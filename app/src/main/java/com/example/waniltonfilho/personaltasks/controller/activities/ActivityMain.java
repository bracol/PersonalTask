...
public class ActivityMain extends BaseActivity {
    ...
    private void bindRecyclerView() {
        mListTransactions = WalletTransactionService.getLastTransactions(1);
    ...
    private void bindSearchView() {
        ...
        mSearchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                Animation animation = AnimationUtils.loadAnimation(ActivityMain.this, android.R.anim.fade_out);
...
//    }
    ...
    private void showDialog(View v){
        ...
        ChangeWalletFragment fragment = new ChangeWalletFragment(0, mTextViewMoney);
