    ...
    public static List<Login> getLogins() {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                CollectionType collectionType = objectMapper.getTypeFactory().constructCollectionType(List.class, Login.class);
                logins = objectMapper.readValue(inputStream, collectionType);
            }
            conn.disconnect();
